...
**[v0.4.0](https://github.com/pmdroid/acpbot/releases/tag/v0.4.0)** — download **one** binary for your platform (`linux-x64`, `linux-arm64`, or notarized `darwin-arm64` / `darwin-x64`). Platform table + Docker: [acpbot.app](https://acpbot.app/#install).
...
sudo mv acpbot-v0.4.0-darwin-arm64 /usr/local/bin/acpbot
acpbot help    # host, worker, setup, services, …
```

Docker: `docker pull ghcr.io/pmdroid/acpbot:v0.4.0`
