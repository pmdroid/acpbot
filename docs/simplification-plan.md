...
**Problem:** Fork is gone; env and fields still say `TACP_ACPX_STATE_DIR` / `acpxStateDir`.

**Options:**

| Id | How |
|----|-----|
| 5a | New primary `TACP_STATE_DIR`; accept old `TACP_ACPX_STATE_DIR` as alias (warn once) |
