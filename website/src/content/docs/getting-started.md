...
No Bun or source checkout required for normal use. Download a **[v0.2.0](https://github.com/pmdroid/acpbot/releases/tag/v0.2.0)** release binary, run setup, pair once.
...
Current release: **[v0.2.0](https://github.com/pmdroid/acpbot/releases/tag/v0.2.0)**. Download **one** artifact for your platform (or use the [landing page install section](/#install)):

| Platform | Artifact | Direct link |
|---|---|---|
| macOS Apple Silicon | `acpbot-v0.2.0-darwin-arm64.tar.gz` (signed) | [download](https://github.com/pmdroid/acpbot/releases/download/v0.2.0/acpbot-v0.2.0-darwin-arm64.tar.gz) |
| macOS Intel | `acpbot-v0.2.0-darwin-x64.tar.gz` (signed) | [download](https://github.com/pmdroid/acpbot/releases/download/v0.2.0/acpbot-v0.2.0-darwin-x64.tar.gz) |
| Linux x86_64 | `acpbot-v0.2.0-linux-x64.tar.gz` | [download](https://github.com/pmdroid/acpbot/releases/download/v0.2.0/acpbot-v0.2.0-linux-x64.tar.gz) |
| Linux arm64 | `acpbot-v0.2.0-linux-arm64.tar.gz` | [download](https://github.com/pmdroid/acpbot/releases/download/v0.2.0/acpbot-v0.2.0-linux-arm64.tar.gz) |
...
sudo mv acpbot-v0.2.0-darwin-arm64 /usr/local/bin/acpbot   # or ~/.local/bin
acpbot help    # host, worker, setup, services, …
```

Checksums ship on the release (`SHA256SUMS`, `SHA256SUMS-darwin-v0.2.0`).
...
Image tags: `v0.2.0`, `0.2.0`, `latest`. Multi-arch (`linux/amd64`, `linux/arm64`).
